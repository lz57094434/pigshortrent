...
public class PageTag extends TagSupport{
    ...
    public int doStartTag() throws JspException {
        ...
        sb.append(".pagination a, .pagination a:link, .pagination a:visited {padding:2px 5px;margin:2px;border:1px solid #b5b5b5;text-decoration:none;color:#006699;}");//字体颜色
        sb.append(".pagination a:hover, .pagination a:active {background:#fff; text-decoration:none;}");//背景颜色
        ...
        sb.append(".pagination span.disabled {padding: 2px 5px;margin: 2px;border: 1px solid #eee; color: blue;}");//上下页颜色
        sb.append("</style>\r\n");
